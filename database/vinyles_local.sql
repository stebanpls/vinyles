...
-- Volcando datos para la tabla vinyles_local.django_migrations: ~27 rows (aproximadamente)
...
-- Volcando datos para la tabla vinyles_local.django_session: ~16 rows (aproximadamente)
