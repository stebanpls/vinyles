    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('P', 'Procesando'), ('E', 'Enviado'), ('C', 'Completado'), ('X', 'Cancelado')], default='P', max_length=1)),
                ('comprador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pedidos', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicacion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='detalles_pedido', to='gestion.publicacion')),
            ],
        ),
        migrations.CreateModel(
            name='TicketSoporte',
