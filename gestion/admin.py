...
from .models import (
    Crud, Cliente, Genero, Artista, Productor, Cancion, Producto, Publicacion,
    ProductoCancion, Pais, Departamento, Ciudad, MedioDePago, Pedido,
    PedidoPublicacion, TicketSoporte
)
