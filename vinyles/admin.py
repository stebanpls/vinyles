...
class VinylesAdminSite(AdminSite):
    site_header = "Administración de Vinyles"  # Encabezado que aparece en la parte superior de la página
    site_title = "Panel de Administración de Vinyles"  # Título que aparece en la pestaña del navegador
